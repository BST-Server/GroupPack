...
import net.william278.husksync.database.DatabaseBackupManager;
...
import net.william278.husksync.listener.InventorySyncListener;
...
public class BukkitHuskSync extends JavaPlugin implements HuskSync, BukkitTask.Supplier,
    ...
    public void onEnable() {
        ...
        // Initialize database auto-backup manager
        initialize("database backup manager", (plugin) -> {
            this.backupManager = new DatabaseBackupManager(this);
        ...
        // Register real-time inventory sync listener (Redis as inventory authority)
    ...
    public void onDisable() {
        ...
        // Terminate backup manager
        if (this.backupManager != null) {
            this.backupManager.terminate();
        }

        // Terminate inventory sync listener
        ...
        // Complete shutdown
        log(Level.INFO, "Successfully disabled GroupPack v" + getPluginVersion());
    }
